...
import homePageTheme from './homePageTheme.js'

class HomePageThemeProvider extends React.Component {
  state = {
  ...
  render() {
    ...
    return (
      <div>
        ...
        />
        <EmotionThemeProvider theme={homePageTheme.light}>{children}</EmotionThemeProvider>
      </div>
    );
  }
}

export default HomePageThemeProvider;
